...
async function runTests() {
  ...
  try {
    ...
    const pmAgentPath = path.join(projectRoot, 'src/modules/xmc/agents/pm.agent.yaml');
  ...
  try {
    const builder = new YamlXmlBuilder();
    const teaAgentPath = path.join(projectRoot, 'src/modules/xmc/agents/tea.agent.yaml');
