# XIAOMA Method - GitHub Copilot Instructions

## Activating Agents

XIAOMA agents are installed as chat modes in `.github/chatmodes/`.

### How to Use

1. **Open Chat View**: Click Copilot icon in VS Code sidebar
2. **Select Mode**: Click mode selector (top of chat)
3. **Choose Agent**: Select the XIAOMA agent from dropdown
