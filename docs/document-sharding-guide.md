...
Comprehensive guide to XiaoMa Method's document sharding system for managing large planning and architecture documents.
...
XiaoMa workflows use a **dual discovery system**:
...
```bash
# Activate xiaoma-master or analyst agent, then:
/shard-doc
```
...
**All XMC workflows support both formats:**
...
- [XMC Workflows Guide](../src/modules/xmc/workflows/README.md) - Workflow overview
- [Workflow Creation Guide](../src/modules/xmb/workflows/create-workflow/workflow-creation-guide.md) - Custom workflow patterns
