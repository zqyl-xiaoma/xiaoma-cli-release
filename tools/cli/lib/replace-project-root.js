 ...
 * Used during XIAOMA installation to set correct paths in agent and task files
 */
...
/**
 * Main installation helper - replaces {project-root} and {output_folder}/ during XIAOMA installation
 * @param {string} installPath - Path where XIAOMA is being installed
...
function processInstallation(installPath, targetProjectRoot, docsOutputPath = 'docs', verbose = false) {
  // Ensure project root has trailing slash since usage is like {project-root}/xiaoma
