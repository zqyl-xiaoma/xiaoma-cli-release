...
- **Greenfield（绿地）工作流**: 从零开始的新项目开发
- **Brownfield（棕地）工作流**: 现有项目的增强和修改
...
### 1. 绿地全栈应用开发工作流 (greenfield-fullstack)
...
### 2. 棕地全栈增强工作流 (brownfield-fullstack)
...
```
architect (UI分析) → pm (棕地PRD) → ux-expert → architect (棕地架构) → po → 开发循环
```
...
### 5. 绿地服务开发工作流 (greenfield-service)
...
### 6. 棕地服务增强工作流 (brownfield-service)
...
```
architect (服务分析) → pm (棕地PRD) → architect (棕地架构) → po → 开发循环
```
...
- `*brownfield-create-story`: PM创建棕地故事
- `*brownfield-create-epic`: PM创建棕地史诗
