...
- Agent manifest CSV is available at `{project-root}/{xiaoma_folder}/_cfg/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/{xiaoma_folder}/_cfg/agent-manifest.csv`
