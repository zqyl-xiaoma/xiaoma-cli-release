...
menu:
  ...
  - trigger: brainstorm
    workflow: '{project-root}/{xiaoma_folder}/core/workflows/brainstorming/workflow.yaml'
...
# GOOD - Portable paths
workflow: "{project-root}/{xiaoma_folder}/xmc/workflows/prd/workflow.yaml"
exec: "{project-root}/{xiaoma_folder}/core/tasks/validate.xml"
...
- `{xiaoma_folder}` - XIAOMA installation folder
...
menu:
  - trigger: workflow-init
    workflow: '{project-root}/{xiaoma_folder}/xmc/workflows/workflow-status/init/workflow.yaml'
