...
- Example: `.xiaoma/custom/agents/journal-keeper/`
...
See: `src/modules/xmb/reference/agents/expert-examples/journal-keeper/`
...
cp -r /path/to/journal-keeper/ .xiaoma/custom/agents/
