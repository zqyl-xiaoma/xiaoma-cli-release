# XMB Module Documentation

Reference documentation for building XIAOMA agents and workflows.
...
Production-ready examples in `/src/modules/xmb/reference/agents/`:
...
- `security-engineer.agent.yaml` - XMC security specialist with threat modeling
