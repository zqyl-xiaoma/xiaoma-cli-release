# CSV Data File Standards for XIAOMA Workflows

## Purpose and Usage

CSV data files in XIAOMA workflows serve specific purposes for different workflow types:
...
When creating CSV data files for XIAOMA workflows:
