# XIAOMA Workflow Step Template

This template provides the standard structure for all XIAOMA workflow step files. Copy and modify this template for each new step you create.
...
# Path Definitions
workflow_path: '{project-root}/{xiaoma_folder}/xmb/reference/workflows/[workflow-name]'
