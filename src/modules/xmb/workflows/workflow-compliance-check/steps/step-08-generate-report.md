...
# Path Definitions
workflow_path: '{project-root}/{xiaoma_folder}/xmb/workflows/workflow-compliance-check'
...
**Date:** {current_date}
**Standards:** XIAOMA workflow-template.md and step-template.md
...
The workflow is complete when the comprehensive compliance report has been generated and the user has selected their preferred next step. The report contains all findings, recommendations, and strategic guidance needed to achieve full XIAOMA compliance.
