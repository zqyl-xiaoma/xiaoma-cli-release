...
Load and read full config from {project-root}/{xiaoma_folder}/xmc/config.yaml and resolve:

- `project_name`, `output_folder`, `user_name`, `communication_language`, `document_output_language`, `user_skill_level`

### 2. First Step EXECUTION

Load, read the full file and then execute `{project-root}/{xiaoma_folder}/xmb/reference/workflows/meal-prep-nutrition/steps/step-01-init.md` to begin the workflow.
