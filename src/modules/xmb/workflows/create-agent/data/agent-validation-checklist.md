# XIAOMA Agent Validation Checklist

Use this checklist to validate agents meet XIAOMA quality standards, whether creating new agents or editing existing ones.

## YAML Structure Validation (Source Files)

- [ ] YAML parses without errors
- [ ] `agent.metadata` includes: `id`, `name`, `title`, `icon`
- [ ] `agent.metadata.module` present if Module agent (e.g., `xmc`, `xmb`, `cis`)
...
- [ ] Compare against reference agents (commit-poet, journal-keeper, XMC agents) - similar quality?
...
- [ ] Designed FOR specific module (XMC, XMB, CIS, etc.)
...
✓ Comparable quality to reference agents (commit-poet, journal-keeper, XMC agents)
