...
**Legacy Workflow:** `src/modules/xmb/workflows-legacy/create-agent/workflow.yaml` + `instructions.md`
**New Workflow:** `src/modules/xmb/workflows/create-agent/workflow.md` + 11 step files
...
- Agent compilation guide: `{project-root}/.xiaoma/xmb/docs/agents/agent-compilation.md`
- Agent types guide: `{project-root}/.xiaoma/xmb/docs/agents/understanding-agent-types.md`
- Architecture docs: simple, expert, module agent architectures
- Menu patterns guide: `{project-root}/.xiaoma/xmb/docs/agents/agent-menu-patterns.md`
