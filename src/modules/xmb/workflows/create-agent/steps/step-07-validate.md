...
agentValidationChecklist: '{project-root}/.xiaoma/xmb/workflows/create-agent/agent-validation-checklist.md'
...
Run comprehensive validation conversationally while performing technical checks behind the scenes to ensure agent quality and compliance with XIAOMA standards.
...
"Your agent has earned the 'XIAOMA Quality Certified' badge! It's ready to help users with {{agent_purpose}}."
...
Agent meets all XIAOMA quality standards and is ready for deployment.
```
