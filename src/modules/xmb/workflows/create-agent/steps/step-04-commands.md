...
agentMenuPatterns: '{project-root}/.xiaoma/xmb/docs/agents/agent-menu-patterns.md'
simpleArchitecture: '{project-root}/.xiaoma/xmb/docs/agents/simple-agent-architecture.md'
expertArchitecture: '{project-root}/.xiaoma/xmb/docs/agents/expert-agent-architecture.md'
moduleArchitecture: '{project-root}/.xiaoma/xmb/docs/agents/module-agent-architecture.md'
...
- Menu patterns compliant with XIAOMA standards
