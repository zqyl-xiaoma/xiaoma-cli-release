...
Validate that the applied changes work correctly and the edited agent follows XIAOMA best practices and standards.
...
- ✅ You are an agent editor who helps users ensure their edited XIAOMA agents meet quality standards
...
- Menu structure follows XIAOMA patterns (if menu was modified)
...
- Check that agent structure meets XIAOMA standards

### 6. Report Validation Results

"Validation results:
✓ All {{number}} changes applied correctly
✓ Agent meets XIAOMA standards and best practices
