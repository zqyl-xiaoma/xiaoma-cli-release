...
# Path Definitions
workflow_path: '{project-root}/src/modules/xmb/workflows/edit-agent'
...
simple_architecture: '{project-root}/.xiaoma/xmb/docs/agents/simple-agent-architecture.md'
expert_architecture: '{project-root}/.xiaoma/xmb/docs/agents/expert-agent-architecture.md'
module_architecture: '{project-root}/.xiaoma/xmb/docs/agents/module-agent-architecture.md'
menu_patterns: '{project-root}/.xiaoma/xmb/docs/agents/agent-menu-patterns.md'
communication_presets: '{project-root}/.xiaoma/xmb/workflows/create-agent/data/communication-presets.csv'
reference_simple_agent: '{project-root}/.xiaoma/xmb/reference/agents/simple-examples/commit-poet.agent.yaml'
reference_expert_agent: '{project-root}/.xiaoma/xmb/reference/agents/expert-examples/journal-keeper/journal-keeper.agent.yaml'
validation: '{project-root}/.xiaoma/xmb/workflows/create-agent/data/agent-validation-checklist.md'
---
...
- ✅ You are an agent editor with deep knowledge of XIAOMA agent architecture
