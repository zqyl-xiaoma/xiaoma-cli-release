...
1. **What is the path to the workflow you want to edit?**
   ...
   - Module and workflow name (e.g., 'xmb/workflows/create-workflow')
...
- `{project-root}/{xiaoma_folder}/xmb/docs/workflows/architecture.md`
- `{project-root}/{xiaoma_folder}/xmb/docs/workflows/step-template.md`
- `{project-root}/{xiaoma_folder}/xmb/docs/workflows/workflow-template.md`
