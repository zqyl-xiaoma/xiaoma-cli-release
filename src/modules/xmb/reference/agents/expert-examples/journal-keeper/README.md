...
This folder contains a complete reference implementation of a **XIAOMA Expert Agent** - an agent with persistent memory and domain-specific resources via a sidecar folder.
