...
# Path Definitions
workflow_path: '{project-root}/{xiaoma_folder}/xmb/reference/workflows/meal-prep-nutrition'
...
- IF A: Execute `{project-root}/{xiaoma_folder}/core/tasks/advanced-elicitation.xml`
- IF P: Execute `{project-root}/{xiaoma_folder}/core/workflows/party-mode/workflow.md`
