...
<critical>You MUST have already loaded and processed: {project-root}/{xiaoma_folder}/xmb/workflows/module-brief/workflow.yaml</critical>
...
- Other XIAOMA modules it might use
