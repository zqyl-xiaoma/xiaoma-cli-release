...
The workflow uses standard XMB configuration:
...
- Review the workflow creation guide at `/{xiaoma_folder}/xmb/workflows/create-workflow/workflow-creation-guide.md`
- Study existing module examples in `/{xiaoma_folder}/` for patterns and inspiration
- Validate output using `checklist.md`
- Consult module structure guide at `create-module/module-structure.md`

---

_Part of the XiaoMa Method v6 - XMB (Builder) Module_
