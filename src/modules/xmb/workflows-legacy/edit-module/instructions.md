...
<critical>You MUST have already loaded and processed: {project-root}/{xiaoma_folder}/xmb/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like {xiaoma_folder}/xmc/ or src/modules/xmc/)</ask>
...
- Study reference modules: XMC, XMB, CIS
- Understand XIAOMA module patterns and conventions
  </action>

<action>Analyze the module deeply:

- Identify module purpose and role in XIAOMA ecosystem
...
2. **Propose improvements with rationale**
   ...
   - Provide examples from reference modules: {xmc_module_dir}, {xmb_module_dir}, {cis_module_dir}
...
- Show how to reference workflows properly: {project-root}/{xiaoma_folder}/{{module}}/workflows/{{workflow}}/workflow.yaml
...
- "Looking at how XMC organized this, we could use {{approach}}"
- "The XIAOMA convention is to {{pattern}} which helps with {{benefit}}"

Connect improvements to broader XIAOMA principles without being preachy.
</action>
...
If this is part of larger XIAOMA work:
