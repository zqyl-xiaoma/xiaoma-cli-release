...
Interactive workflow for editing existing XIAOMA modules, including structure, agents, workflows, configuration, and documentation.

## Purpose

This workflow helps you improve and maintain XIAOMA modules by:
...
```yaml
# In agent menu item:
workflow: '{project-root}/{xiaoma_folder}/other-module/workflows/shared-workflow/workflow.yaml'
```

Common patterns:

- XMC uses CIS brainstorming workflows
...
**Installed modules** (in {xiaoma_folder}/):
...
```
User: I want to add a new workflow to XMC for API design
Workflow: Analyzes XMC → You choose option 8 (add new workflow)
...
Invoke via XiaoMa Builder agent:
...
- **XMC Module** - Example of full-featured module
- **XMB Module** - Example of builder/tooling module
