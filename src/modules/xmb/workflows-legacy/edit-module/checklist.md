...
Use this checklist to validate module edits meet XiaoMa Core standards.

## Module Structure Validation

- [ ] Module has clear 3-letter code (xmc, xmb, cis, etc.)
- [ ] Module is in correct location (src/modules/ for source, {xiaoma_folder}/ for installed)
- [ ] agents/ directory exists
- [ ] workflows/ directory exists
- [ ] config.yaml exists in module root
- [ ] README.md exists in module root
- [ ] Directory structure follows XIAOMA conventions
...
- [ ] README explains module's role in XIAOMA ecosystem
...
- [ ] Paths are {xiaoma_folder}/-relative (not project-root)
