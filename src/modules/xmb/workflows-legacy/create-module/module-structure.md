# XIAOMA Module Structure Guide

## What is a Module?

A XIAOMA module is a self-contained package of agents, workflows, tasks, and resources that work together to provide specialized functionality. Think of it as an expansion pack for the XIAOMA Method.
...
```
# SOURCE MODULE (in XIAOMA-CLI project)
...
{project-root}/{xiaoma_folder}/{module-code}/
...
menu:
  - trigger: command-name
    workflow: '{project-root}/{xiaoma_folder}/SOURCE_MODULE/workflows/path/workflow.yaml'
    workflow-install: '{project-root}/{xiaoma_folder}/THIS_MODULE/workflows/vendored/workflow.yaml'
...
data_path:
  result: '{project-root}/{xiaoma_folder}/module-code/data'
```
