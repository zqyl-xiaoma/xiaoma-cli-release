...
_Context provided to brainstorming workflow when creating a new XIAOMA module_

## Session Focus

You are brainstorming ideas for a **complete XIAOMA module** - a self-contained package that extends the XIAOMA Method with specialized domain expertise and capabilities.

## What is a XIAOMA Module?
...
A good XIAOMA module should be:
...
_This focused context helps create cohesive, valuable XIAOMA modules_
