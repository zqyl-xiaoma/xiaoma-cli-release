# XMB - XiaoMa Builder Module

Specialized tools and workflows for creating, customizing, and extending XiaoMa components including agents, workflows, and complete modules.
...
**XiaoMa Builder** - Master builder agent orchestrating all creation workflows with deep knowledge of XiaoMa architecture and conventions.

- Location: `.xiaoma/xmb/agents/xiaoma-builder.md`

### 📋 Workflows

**Active Workflows** (Step-File Architecture)

- Location: `src/modules/xmb/workflows/`
- 5 core workflows with 41 step files total
- Template-based execution with JIT loading

**Legacy Workflows** (Being Migrated)

- Location: `src/modules/xmb/workflows-legacy/`
- Module-specific workflows pending conversion to step-file architecture

### 📚 Documentation

- Location: `src/modules/xmb/docs/`
- Comprehensive guides for agents and workflows
- Architecture patterns and best practices

### 🔍 Reference Materials

- Location: `src/modules/xmb/reference/`
...
- **[Module Agent Examples](./reference/agents/module-examples/)** - Integration patterns (XMC, CIS)
...
**[create-agent](./workflows/create-agent/)** - Build XiaoMa agents
...
XMB creates three agent architectures:
...
- **Examples**: XMC project manager, CIS innovation strategist

## Quick Start

### Using XiaoMa Builder Agent

1. **Load XiaoMa Builder agent** in your IDE:
   ```
   /xiaoma:xmb:agents:xiaoma-builder
   ```
...
XMB components integrate with:

- **XiaoMa Core** - Framework foundation and agent compilation
- **XMC** - Development workflows and project management
...
XMB provides a complete toolkit for extending XiaoMa Method with disciplined, systematic approaches to agent and workflow development while maintaining framework consistency and power.
