# XMC Claude Code Sub-Module

## Overview

This sub-module provides Claude Code-specific enhancements for the XMC module, including specialized subagents and content injection for enhanced AI-assisted development workflows.

## How the Installer Works

When Claude Code is selected during XIAOMA installation:
...
1. Run the XIAOMA installer
2. Select XMC module and Claude Code
3. Verify prompts appear for subagent selection
4. Check `.claude/agents/` for installed subagents
5. Verify injection points are replaced in `.claude/commands/{xiaoma_folder}/` and the various tasks and templates under `{xiaoma_folder}/...`
