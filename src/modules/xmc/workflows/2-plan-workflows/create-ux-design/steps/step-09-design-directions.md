...
- Execute {project-root}/{xiaoma_folder}/core/tasks/advanced-elicitation.xml with the current design direction content
...
- Execute {project-root}/{xiaoma_folder}/core/workflows/party-mode/workflow.md with the current design direction
