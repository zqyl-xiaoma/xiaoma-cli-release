...
- installed_path = `{project-root}/{xiaoma_folder}/xmc/workflows/2-plan-workflows/prd`
...
- Execute {project-root}/{xiaoma_folder}/core/tasks/advanced-elicitation.xml with the current content
...
- Execute {project-root}/{xiaoma_folder}/core/workflows/party-mode/workflow.md with the current content
