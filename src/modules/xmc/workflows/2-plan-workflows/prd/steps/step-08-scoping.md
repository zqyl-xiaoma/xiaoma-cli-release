...
- Execute {project-root}/{xiaoma_folder}/core/tasks/advanced-elicitation.xml with current scoping analysis
...
- Execute {project-root}/{xiaoma_folder}/core/workflows/party-mode/workflow.md with scoping context
