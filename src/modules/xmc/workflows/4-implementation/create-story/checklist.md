...
- The `{project_root}/{xiaoma_folder}/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project_root}/{xiaoma_folder}/core/tasks/validate-workflow.xml`
