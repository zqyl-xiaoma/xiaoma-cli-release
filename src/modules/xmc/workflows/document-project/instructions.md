...
<critical>You MUST have already loaded and processed: {project-root}/{xiaoma_folder}/xmc/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/{xiaoma_folder}/xmc/workflows/workflow-status">
...
- Mode: {{workflow_mode}}
- Scan Level: {{scan_level}}
- Output: {output_folder}/xmc-index.md and related files
