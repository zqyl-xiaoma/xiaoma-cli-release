...
**Note:** XiaoMa artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of XiaoMa artifacts does NOT halt workflow
...
**XiaoMa-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (XiaoMa-Integrated, Standalone, Auto-discover)
...
### With XiaoMa Workflows (If Available - OPTIONAL)
...
### Issue: XiaoMa artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require XiaoMa artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without XiaoMa context
...
- Message: "Framework scaffolding required. Run `xiaoma tea *framework` first."
...
- **automate is flexible:** Can work with or without XiaoMa artifacts (story, tech-spec, PRD are OPTIONAL)
