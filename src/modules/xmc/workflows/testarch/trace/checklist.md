...
- [ ] Story file is accessible (if using XiaoMa mode)
...
- [ ] Gate decision appended to xmc-workflow-status.md (if append_to_history: true)
...
- [ ] Gate decision added to `xmc-workflow-status.md`
