# XMC Frequently Asked Questions

Quick answers to common questions about the XiaoMa Method Module.
...
1. Install XiaoMa Method: `npx xiaoma-cli@alpha install`
...
**A:** Check your `xmc-workflow-status.md` file (created by workflow-init). It shows your current phase and progress. If you don't have this file, you can also tell by what you're working on:
...
XMC respects your choice - it won't force modernization, but it will offer it.
...
All XMC docs use valid Mermaid syntax that should render in GitHub, VS Code, and most IDEs.

### Q: Can I use XMC with GitHub Copilot / Cursor / other AI tools?

**A:** Yes! XMC is complementary. XMC handles:
...
### Q: What IDEs/tools support XMC?

**A:** XMC requires tools with **agent mode** and access to **high-quality LLM models** that can load and follow complex workflows, then properly implement code changes.
...
- **Claude Code** ⭐ **Best choice**
  ...
  - Native agent mode designed for XMC workflows
...
**Why model quality matters:** XMC workflows require LLMs that can follow multi-step processes, maintain context across phases, and implement code that adheres to specifications. Tools with weaker models will struggle with workflow adherence and code quality.

See [IDE Setup Guides](https://github.com/xiaoma-code-org/XIAOMA-CLI/tree/main/docs/ide-info) for configuration specifics.

### Q: Can I customize agents?

**A:** Yes! Agents are installed as markdown files with XML-style content (optimized for LLMs, readable by any model). Create customization files in `{xiaoma_folder}/_cfg/agents/[agent-name].customize.yaml` to override default behaviors while keeping core functionality intact. See agent documentation for customization options.
...
### Q: Can I use XMC for non-software projects?

**A:** XMC is optimized for software development, but the methodology principles (scale-adaptive planning, just-in-time design, context injection) can apply to other complex project types. You'd need to adapt workflows and agents for your domain.
...
Trust your expertise - XMC supports your decisions.

### Q: Can multiple developers work on the same XMC project?
...
**With XMC + AI agents:** A single dev can complete an entire epic in 1-3 days. What used to take months now takes days.
...
- Use **git submodules** for XMC installation (not .gitignore)
...
- Use git submodules for XMC in enterprise settings
...
**A:** Party mode is a unique multi-agent collaboration feature where ALL your installed agents (19+ from XMC, CIS, XMB, custom modules) discuss your challenges together in real-time.

**How it works:**

1. Run `/xiaoma:core:workflows:party-mode` (or `*party-mode` from any agent)
2. Introduce your topic
3. XiaoMa Master selects 2-3 most relevant agents per message
...
3. Open a [GitHub Issue](https://github.com/xiaoma-code-org/XIAOMA-CLI/issues)
4. Watch [YouTube Tutorials](https://www.youtube.com/@XiaoMaCode)

### Q: How do I report a bug or request a feature?

**A:** Open a GitHub issue at: https://github.com/xiaoma-code-org/XIAOMA-CLI/issues

Please include:

- XMC version (check your installed version)
...
- [Quick Start Guide](quick-start.md) - Get started with XMC
...
**Have a question not answered here?** Please [open an issue](https://github.com/xiaoma-code-org/XIAOMA-CLI/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
