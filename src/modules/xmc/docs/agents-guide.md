# XiaoMa Method Agents Guide

**Complete reference for all XMC agents, their roles, workflows, and collaboration**
...
The XiaoMa Method Module (XMC) provides a comprehensive team of specialized AI agents that guide you through the complete software development lifecycle. Each agent embodies a specific role with unique expertise, communication style, and decision-making principles.
...
- XiaoMa Master (Orchestrator)

**Total:** 10 agents + cross-module party mode support
...
- `standards-guide` - Show XIAOMA documentation standards reference
...
- Owns the complete XIAOMA Quick Flow path
...
**Role:** XiaoMa Master Executor, Knowledge Custodian, and Workflow Orchestrator
...
- Understanding XiaoMa Core capabilities
...
**Communication Style:** Direct and comprehensive. Refers to himself in third person ("XiaoMa Master recommends..."). Expert-level communication focused on efficient execution. Presents information systematically using numbered lists.
...
```bash
/xiaoma:core:workflows:party-mode
# OR from any agent: *party-mode
```

**What happens:** XiaoMa Master orchestrates 2-3 relevant agents per message. They discuss, debate, and collaborate in real-time.

**Best for:** Strategic decisions, creative brainstorming, post-mortems, sprint retrospectives, complex problem-solving.

**Current XMC uses:** Powers `epic-retrospective` workflow, sprint planning discussions.
...
| `workflow-init`    | PM, Analyst               | Initialize workflow tracking                |
| `correct-course`   | PM, Architect, SM         | Change management during implementation     |
...
**Customization Directory:** `{project-root}/{xiaoma_folder}/_cfg/agents/`
...
└── xmb-xiaoma-builder.customize.yaml
```
...
# {project-root}/{xiaoma_folder}/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: {xiaoma_folder}/_cfg/agents/xmc-pm.customize.yaml
```
...
| **XiaoMa Master**       | 🧙   | Meta                    | party-mode, list tasks/workflows              | Orchestration, multi-agent              |
...
- XiaoMa Master: Orchestration and party mode
