...
Complete guides for the XiaoMa Method Module (XMC) - AI-powered agile development workflows that adapt to your project's complexity.

---

## 🚀 Getting Started

**New to XMC?** Start here:
...
**[Complete Workflow Diagram](images/workflow-method-greenfield.svg)** - Visual flowchart showing all phases, agents (color-coded), and decision points for the XiaoMa Method standard greenfield track.

---

## 📖 Core Concepts

Understanding how XMC adapts to your needs:

- **[Scale Adaptive System](scale-adaptive-system.md)** - How XMC adapts to project size and complexity (42 min read)
  - Three planning tracks (Quick Flow, XiaoMa Method, Enterprise Method)
  - Automatic track recommendation
  - Documentation requirements per track
  - Planning workflow routing

- **[XIAOMA Quick Flow](xiaoma-quick-flow.md)** - Fast-track development workflow (32 min read)
...
- **[Quick Flow Solo Dev Agent](quick-flow-solo-dev.md)** - Elite solo developer for rapid development (18 min read)
  ...
  - Lives and breathes the XIAOMA Quick Flow workflow
...
Complete guide to XMC's AI agent team:

- **[Agents Guide](agents-guide.md)** - Comprehensive agent reference (45 min read)
  - 12 specialized XMC agents + XiaoMa Master
...
- **[Party Mode Guide](party-mode.md)** - Multi-agent collaboration (20 min read)
  ...
  - Multi-module integration (XMC + CIS + XMB + custom)
...
→ Go to [XIAOMA Quick Flow](xiaoma-quick-flow.md) for rapid development
...
Comprehensive documentation for all XMC workflows organized by phase:
...
- **[Phase 2: Planning Workflows](workflows-planning.md)** - Scale-adaptive planning (967 lines)
  ...
  - Track-based planning approach (Quick Flow, XiaoMa Method, Enterprise Method)
...
- **[Phase 3: Solutioning Workflows](workflows-solutioning.md)** - Architecture and validation (638 lines)
  ...
  - Required for XiaoMa Method and Enterprise Method tracks
...
- **[Testing & QA Workflows](test-architecture.md)** - Comprehensive quality assurance (1,420 lines)
  ...
  - XiaoMa-integrated vs standalone modes
...
Understanding XMC components:

- **[XMC Module README](../README.md)** - Overview of module structure
...
- **[GitHub Issues](https://github.com/xiaoma-code-org/XIAOMA-CLI/issues)** - Report bugs or request features
- **[YouTube Channel](https://www.youtube.com/@XiaoMaCode)** - Video tutorials and walkthroughs
...
flowchart TD
    ...
    DECIDE -->|Bug fix or<br/>small feature| QF[XIAOMA Quick Flow]
