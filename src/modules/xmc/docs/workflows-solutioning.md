# XMC Solutioning Workflows (Phase 3)
...
**Required for:** XiaoMa Method (complex projects), Enterprise Method

**Optional for:** XiaoMa Method (simple projects), Quick Flow (skip entirely)
...
| ---------------------------- | ----------- | -------------------------- | -------------------------------------------- |
| **create-ux-design**         | UX Designer | XiaoMa Method, Enterprise  | Optional UX design (after PRD, before arch)  |
| **architecture**             | Architect   | XiaoMa Method, Enterprise  | Technical architecture and design decisions  |
| **create-epics-and-stories** | PM          | XiaoMa Method, Enterprise  | Break FRs/NFRs into epics after architecture |
| **implementation-readiness** | Architect   | XiaoMa Complex, Enterprise | Validate planning/solutioning completeness   |
...
- **XiaoMa Method:** Multi-epic projects need architecture to prevent conflicts
- **Enterprise:** Same as XiaoMa Method, plus optional extended workflows (test architecture, security architecture, devops strategy) added AFTER architecture but BEFORE gate check
...
- Multi-epic projects (XiaoMa Complex, Enterprise)
...
- XiaoMa Method Simple with straightforward tech stack
...
- **Always** before Phase 4 for XiaoMa Complex and Enterprise projects
...
- XiaoMa Simple (no gate check required)
...
**Note:** Enterprise uses the same planning and architecture as XiaoMa Method. The only difference is optional extended workflows added AFTER architecture but BEFORE create-epics-and-stories.
...
Don't over-architect simple projects. XiaoMa Simple projects need simple architecture.
...
- **Planning:** prd (PM) - creates FRs/NFRs only (same as XiaoMa Method)
...
**Key Difference:** Enterprise adds optional extended workflows AFTER architecture but BEFORE create-epics-and-stories. Everything else is identical to XiaoMa Method.
...
- Use architecture for XiaoMa Method and Enterprise (both required)
...
A: No. Quick Flow skips it. XiaoMa Method and Enterprise both require it.

**Q: How do I know if I need architecture?**
A: If you chose XiaoMa Method or Enterprise track in planning (workflow-init), you need architecture to prevent agent conflicts.
...
A: Only for Quick Flow. XiaoMa Method and Enterprise both require gate check before Phase 4.
...
A: XiaoMa Method: 1-2 days for architecture. Enterprise: 2-3 days total (1-2 days architecture + 0.5-1 day optional extended workflows). If taking longer, you may be over-documenting.
