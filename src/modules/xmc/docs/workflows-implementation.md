# XMC Implementation Workflows (Phase 4)
...
Phase 4 is the final phase of the XiaoMa Method workflow. To see how implementation fits into the complete methodology:

The XiaoMa Method consists of four phases working in sequence:
