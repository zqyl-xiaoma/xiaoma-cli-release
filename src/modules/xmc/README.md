...
👉 **[XMC Documentation Hub](docs/README.md)** - Start here for complete guides, tutorials, and references

**Quick Links:**

- **[Quick Start Guide](docs/quick-start.md)** - New to XMC? Start here (15 min)
- **[Agents Guide](docs/agents-guide.md)** - Meet your 12 specialized AI agents (45 min)
- **[Scale Adaptive System](docs/scale-adaptive-system.md)** - How XMC adapts to project size (42 min)
...
**Orchestration:** XiaoMa Master (from Core)
...
XMC automatically adjusts to project complexity (Levels 0-4):
...
Use party mode to engage all 19+ agents (from XMC, CIS, XMB, custom modules) in group discussions for strategic decisions, creative brainstorming, and complex problem-solving.
...
- **[YouTube](https://www.youtube.com/@XiaoMaCode)** - Video tutorials and walkthroughs
