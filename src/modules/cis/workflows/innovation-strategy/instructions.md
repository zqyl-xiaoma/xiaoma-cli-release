...
<critical>The workflow execution engine is governed by: {project_root}/{xiaoma_folder}/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project_root}/{xiaoma_folder}/cis/workflows/innovation-strategy/workflow.yaml</critical>
