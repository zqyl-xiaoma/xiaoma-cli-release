...
Edit `/{xiaoma_folder}/cis/config.yaml`:
...
- **XMC** - Powers project brainstorming
- **XMB** - Creative module design
...
- **[XMC Integration](../xmc/README.md)** - Development workflow connection

---

Part of XiaoMa Method v6.0 - Transform creative potential through expert AI facilitation.
