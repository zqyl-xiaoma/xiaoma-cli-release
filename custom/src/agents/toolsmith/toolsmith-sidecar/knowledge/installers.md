...
- @/tools/cli/xiaoma-cli.js - Main CLI entry (uses Commander.js, auto-loads commands)
...
- @/tools/cli/installers/lib/ide/shared/xiaoma-artifacts.js
...
| cursor         | Cursor         | .cursor/rules/xiaoma/       | .mdc with MDC frontmatter     |
| github-copilot | GitHub Copilot | .github/                    | .md                           |
| opencode       | OpenCode       | .opencode/                  | .md                           |
| windsurf       | Windsurf       | .windsurf/workflows/xiaoma/ | .md with workflow frontmatter |
...
- `setup(projectDir, xiaomaDir, options)` - Main installation
