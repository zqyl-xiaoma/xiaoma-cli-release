...
- @/src/modules/xmb/ - XIAOMA Builder module
- @/src/modules/xmc/ - XIAOMA Method module (flagship)
...
### XMC Sub-modules (Example)

- @/src/modules/xmc/sub-modules/claude-code/
...
| -------------- | --------------------------- | -------------- |
| Claude Code    | .claude/commands/xiaoma/    | .md            |
| Cursor         | .cursor/rules/xiaoma/       | .mdc           |
| Windsurf       | .windsurf/workflows/xiaoma/ | .md            |
